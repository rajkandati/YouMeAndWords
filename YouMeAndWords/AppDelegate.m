...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (self.homeViewController && [self.homeViewController respondsToSelector:@selector(setManagedObjectContext:)]) 
    {
        self.homeViewController.managedObjectContext = self.managedObjectContext;
        //self.homeViewController.player = player;
    }
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:[storeURL path]]) {
        NSURL *preloadURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"YouMeAndWordsData" ofType:@"sqlite"]];
        ...
        /*dispatch_queue_t databaseCopier = dispatch_queue_create("copy database to documents directory", NULL);
        dispatch_async(databaseCopier, ^{
        ...
        dispatch_release(databaseCopier);*/
    }
